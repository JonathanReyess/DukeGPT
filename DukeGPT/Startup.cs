...
namespace DukeGPT
{
    public class Startup
    {
        ...
        public Startup(IConfiguration configuration)
        {
            ...
            _blobTranscripts = new BlobsTranscriptStore(Configuration.GetValue<string>("BlobConnectionString"), Configuration.GetValue<string>("BlobContainerName"));
        }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Use the BlobsTranscriptStore to store transcripts in Blob Storage
